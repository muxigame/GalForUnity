...
//#endif
        ...
        public NodeRenameAttribute(string name,string tooltip):this(name,typeof(GfuPort)){
#if UNITY_EDITOR
            this.tooltip = tooltip;
#endif
        }
        public NodeRenameAttribute(string name):this(name,typeof(GfuPort)){ }

        public NodeRenameAttribute():this("None",typeof(GfuPort)){ }
