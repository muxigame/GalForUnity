...
namespace GalForUnity.Model{
    ...
    /// </summary>
    [Serializable]
    public class RoleData : MonoBehaviour, IEnumerable<RoleDataItem>{
        [SerializeField]
        // [SaveFlag]
        public List<RoleDataItem> dataArray;

        [NonSerialized] private readonly Dictionary<string, RoleDataItem> _dataMap = new Dictionary<string, RoleDataItem>();
        ...
        public RoleDataItem GetItem(string itemName){ return Data._dataMap[itemName]; }

        public RoleDataItem GetItem(int itemIndex){ return Data.dataArray[itemIndex]; }

        /// <summary>
        ///     获得所有的属性名
        /// </summary>
        public string[] Names{
            get{ return Data._dataMap.Keys.ToArray(); }
        }
        ...
        public int Size(){ return dataArray.Count; }

        public List<RoleDataItem> GetData(){ return dataArray; }
        ...
        public override bool Equals(object x){
            switch (x){
                ...
                case RoleData otherRoleData:
                    return Equals(otherRoleData, dataArray.ToArray());
                default:
                    return false;
            }
        }
        ...
        /// </summary>
        /// <returns>迭代器</returns>
        public IEnumerator<RoleDataItem> GetEnumerator(){ return new RoleDateEnumerator(dataArray); }

        /// <summary>
        ///     获得迭代器的方法
        /// </summary>
        /// <returns>迭代器</returns>
        IEnumerator IEnumerable.GetEnumerator(){ return new RoleDateEnumerator(dataArray); }

        public static bool operator ==(RoleData roleModel, RoleData roleModel1){ return Equals(roleModel, roleModel1); }
        ...
        public static bool operator !=(RoleData roleModel, RoleData roleModel1){ return !(roleModel == roleModel1); }
        ...
        private sealed class RoleDateEnumerator : ICloneable, IEnumerator<RoleDataItem>{
            ...
            public RoleDateEnumerator(List<RoleDataItem> roleDataItems){ this._roleDataItems = (List<RoleDataItem>) roleDataItems.Clone(); }
