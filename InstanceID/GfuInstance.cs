...
namespace GalForUnity.InstanceID{
    ...
    public class GfuInstance : MonoBehaviour{
        ...
        public static T FindObjectsWithGfuInstanceID<T>(long gfuInstanceID) where T : Object{
            return FindObjectsWithGfuInstanceID(gfuInstanceID, typeof(T)) as T;
        }
        ...
        public static T FindAllWithGfuInstanceID<T>(long gfuInstanceID) where T : Object{
            return FindAllWithGfuInstanceID(gfuInstanceID, typeof(T)) as T;
        }
        ...
        private void OnDestroy(){
            GfuInstances.Remove(instanceID);
        }

        private static T[] ObjectOfType<T>() where T:Object{
            return FindObjectsOfType<T>();
        }
        private static T[] AllOfType<T>() where T:Object{
        ...
        private static void SceneOpening(string path,OpenSceneMode openSceneMode){
            Clear();
        }
        ...
        private static void Clear(string arg1, CompilerMessage[] arg2){
            Clear();
        }
