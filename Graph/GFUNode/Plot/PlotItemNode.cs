...
namespace GalForUnity.Graph.GFUNode.Plot{
    ...
    public class PlotItemNode : BaseFieldNode{
        ...
        [Rename(nameof(isCanJump))]
        public bool isCanJump = true;
        // [NodeFieldType(typeof(bool),nameof(isAutoHighLight))]
        [Rename(nameof(isAutoHighLight))]
        public bool isAutoHighLight = true;
        [NonSerialized]
        ...
        public override void Init(NodeData otherNodeData){
            ...
            Name.RegisterValueChangedCallback((delegate(ChangeEvent<string> evt){
                name = evt.newValue;
            }));
            ...
            Speak.RegisterValueChangedCallback((delegate(ChangeEvent<string> evt){
                speak = evt.newValue;
            }));
            ...
            IsCanJump.RegisterValueChangedCallback((delegate(ChangeEvent<bool> evt){
                isCanJump = evt.newValue;
            }));
            IsAutoHighLight.RegisterValueChangedCallback((delegate(ChangeEvent<bool> evt){
                isAutoHighLight = evt.newValue;
            }));
            Script.RegisterValueChangedCallback((delegate(ChangeEvent<Object> evt){
                this.Script = (PlotScript) evt.newValue;
            }));
#endif
        }
        ...
        public override RoleData Execute(RoleData roleData){
            ...
            if (!_isExecuting){
                ...
                if (isAutoHighLight){
                    RunOnMono.LateUpdate(-1, delegate{
                        RoleController.AutoHighLight_S(name);
                    });
                }
            } else{
