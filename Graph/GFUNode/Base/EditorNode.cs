...
namespace GalForUnity.Graph.GFUNode.Base{
...
#endif
    {
        ...
        internal GfuNode SetPosition(){
            return SetPosition(nodeData);
        }
        public bool IsSubClassOf(FieldInfo fieldInfo, Type parentType){
            return IsSubClassOf(fieldInfo.FieldType,parentType);
        }
        /// <summary>
        /// Normal Method 
        /// </summary>
