...
namespace GalForUnity.Graph.Data{
    ...
    public class PortData:DataInfo{
        ...
        public List<NodeData.NodeFieldInfo> jsonField{ get=> JsInfos; set=>JsInfos =value;}
        ...
        public List<NodeData.ListData> listField{ get=>ListJsonInfos; set=>ListJsonInfos=value; }
