        ...
        public PlotVideoBlockUxml(){
            ...
            _blockContentUxml = new BlockContentUxml(() => {
                ...
                searchTypeProvider.OnSelectEntryHandler += (x, y) => {
                    var fieldInfo = (FieldInfo) x.userData;
                    if (_blockContentUxml.Content.Q<GfuConfigFieldUXml>(fieldInfo.Name) != null) return true;
                    _blockContentUxml.Content.Add(new GfuConfigFieldUXml(fieldInfo,galConfig));
                    return true;
                };
            ...
            _blockPortUxml = new BlockPortUxml(() => {
                ...
                searchTypeProvider.OnSelectEntryHandler += (x, y) => {
                    var fieldInfo = (FieldInfo) x.userData;
                    var gfuTogglePort = new GfuTogglePort(fieldInfo,galConfig);
