...
namespace GalForUnity.Graph{
    [Serializable]
    public class GalPortAsset{
        [SerializeField] public string portName;
        [HideInInspector] [SerializeReference] public GalNodeAsset node;
        ...
        public static implicit operator bool(GalPortAsset galNode){
            if (galNode == null) return false;
            return true;
        }
    }
